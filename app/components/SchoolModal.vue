              ...
              <form @submit.prevent="handleSubmit">
                <div>
                  <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-indigo-100">
                    <BuildingOfficeIcon v-if="!school" class="h-6 w-6 text-indigo-600" />
                ...
                <div class="mt-6 space-y-4">
                  ...
                  <!-- UAI (Code école) -->
                  <div>
                    <label for="uai" class="block text-sm font-medium leading-6 text-gray-900">
                      UAI (Code école)
                    </label>
                    <div class="mt-1">
                      <input
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                      Unité Administrative Immatriculée (optionnel)
                    </p>
                  </div>
...
import { BuildingOfficeIcon, PencilIcon, ExclamationTriangleIcon } from '@heroicons/vue/24/outline'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const schoolData = {
      ...
      uai: form.value.uai.trim() || undefined,
      city: form.value.city.trim() || undefined
    }

    // Emit save event
    await emit('save', schoolData)
