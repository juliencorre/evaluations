...
.level-not-acquired {
  background: #cc5c5c; /* Couleur error harmonieuse */
}

.level-in-progress {
  background: #88b8cc; /* Primary-80 pour "en cours" */
}

.level-acquired {
  background: #007d8a; /* Primary-50 pour "acquis" */
}

.level-expert {
  background: var(--md-sys-color-primary, #4A90A4); /* Primary pour "expert" */
}
