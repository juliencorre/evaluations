...
const translateAccountError = (error: unknown) => {
  if (error && typeof error === 'object' && 'message' in error && typeof (error as { message?: string }).message === 'string') {
    ...
    if (message.includes('reconnecter') || message.includes('session')) {
      return 'Votre mot de passe a été mis à jour. Merci de vous reconnecter pour sécuriser votre session.'
    }
  }
